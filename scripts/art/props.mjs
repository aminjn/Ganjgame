...
export const SCENERY = {
  ...
  reeds: () => svg(120, 120, `<g transform="translate(60 112)"><path d="M-30 0 c-2-40 2-60 6-70 M-12 0 c0-44 4-66 8-78 M8 0 c2-40 -2-60 -6-72 M26 0 c0-36 -2-54 -6-64" fill="none" stroke="#4f6b30" stroke-width="5"/><path d="M-24 -70 c-4-8 0-16 2-18 c4 6 4 14 -2 18z M-4 -78 c-4-8 0-18 2-20 c4 6 6 16 -2 20z M2 -72 c-4-8 0-14 2-16 c4 6 4 12 -2 16z" fill="url(#brown)" stroke-width="2"/><ellipse cx="0" cy="0" rx="34" ry="8" fill="#3f5a28" stroke="none" opacity=".5"/></g>`),
  fog: () => svg(200, 80, `<g opacity=".55" stroke="none"><ellipse cx="60" cy="50" rx="50" ry="18" fill="#cfe3c0"/><ellipse cx="120" cy="44" rx="60" ry="22" fill="#cfe3c0"/><ellipse cx="150" cy="56" rx="40" ry="14" fill="#cfe3c0"/></g>`),
